	...
	if (isset($_POST["checkOutDetails"])) {
		if (mysqli_num_rows($query) > 0) {
			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					echo '<input type="submit" style="float:right;margin-right:80px;" name="login_user_with_product" class="btn btn-info btn-lg" value="Checkout" >
							</form>';
						...
						<form action="customer_order.php" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
									...
									<input type="submit" style="float:right;margin-right:80px;" name="login_user_with_product" class="btn btn-info btn-lg" value="Checkout" >
